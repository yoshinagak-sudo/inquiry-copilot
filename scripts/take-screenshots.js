...
// === 撮影対象ページ ===
const NEW_INQUIRY_ID = 'cmoi8xvsq0018a5rdbmvdu3vl'; // 未送信 — 既成型トロフィー（tk_18 ヒット、Gmail 由来）
const SENT_INQUIRY_ID = 'cmoi8xvsc000na5rdi3vrbal8'; // 送信済み — アクリルキーホルダー大量発注（Gmail 由来）
