...
// === 撮影対象ページ ===
const NEW_INQUIRY_ID = 'cmotiy21q000ltvrd9p74h3td'; // 未送信 — 既成型トロフィー（tk_18 ヒット、Gmail 由来）
const SENT_INQUIRY_ID = 'cmotiy21r000otvrd0u8rq1no'; // 送信済み — アクリルキーホルダー大量発注（Gmail 由来）
