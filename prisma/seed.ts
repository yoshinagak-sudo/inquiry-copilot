...
## 見積もり手順
1. 必要な品種・等級・月間使用量・配送先・希望納期を info@butaifarm.example までメール
...
## 不良品の場合
- 商品到着後 7 日以内に info@butaifarm.example へ写真付きで連絡
...
## 対応窓口
カスタマーサポート: info@butaifarm.example（営業時間 平日 9:00-17:00）`,
  },
  {
...
- 応募方法: 採用ページ butaifarm.example/recruit から
...
- 1 回あたり最大 20 名
- 事前予約制（2 週間前まで）
- 申込: butaifarm.example/factory-tour
...
## 申込
営業担当（保育園事業: 佐藤）まで。butaifarm.example/daycare から問い合わせ可。`,
  },
];
...
const INQUIRIES = [
  ...
  },
  {
    ...
    body: "12月に仙台市にふるさと納税で寄付し、舞台ファームのお米を返礼品として選びました。3月になっても発送通知が来ないのですが、状況を教えてください。寄付番号は SND-2025-12-3421 です。",
    category: "ふるさと納税",
  },
  {
    fromName: "田中 美咲",
  ...
  },
  {
    ...
    body: "シンガポール在住です。日本の家族にプレゼントとして舞台ファームのお米を贈りたいのですが、海外への直接発送は可能でしょうか？",
    category: "その他",
  },
];
